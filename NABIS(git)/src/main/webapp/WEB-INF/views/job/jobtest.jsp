...
<h5 id="offcanvasEndLabel1" class="offcanvas-title">직무</h5>
<div id="originTree">
    ...
    >
      ...
      <div class="offcanvas-header border-bottom">
        <h5 id="offcanvasEndLabel" class="offcanvas-title">직무 설정</h5>
        <button 
          type="button"
...
$('.offcanvas').on('show.bs.offcanvas', function() {
    ...
    //formT 초기화
	data = [];
	selectJobList();	//ajax jobList최신화
    console.log("selectJobList()호출 후 jobList : ",jobList);
...
totalNode = function(){
	...
	if($formT.jstree(true)){
		...
		$("#offcanvasEndLabel1").text("전체 직무 ("+ totalNum + ")");
