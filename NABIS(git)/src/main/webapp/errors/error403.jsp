...
>
  <head>
    ...
    <link rel="stylesheet" href="${cPath}/resources/assets/vendor/fonts/fontawesome.css" />
    <link rel="stylesheet" href="${cPath}/resources/assets/vendor/fonts/flag-icons.css" />

    <!-- Core CSS -->
    <link rel="stylesheet" href="${cPath}/resources/assets/vendor/css/rtl/core.css" class="template-customizer-core-css" />
    <link rel="stylesheet" href="${cPath}/resources/assets/vendor/css/rtl/theme-default.css" class="template-customizer-theme-css" />
    ...
    <link rel="stylesheet" href="${cPath}/resources/assets/vendor/libs/typeahead-js/typeahead.css" />

    <!-- Page CSS -->
    <!-- Page -->
    <link rel="stylesheet" href="${cPath}/resources/assets/vendor/css/pages/page-misc.css" />
    <!-- Helpers -->
    <script src="${cPath}/resources/assets/vendor/js/helpers.js"></script>

    <!--! Template customizer & Theme config files MUST be included after core stylesheets and helpers.js in the <head> section -->
    <!--? Template customizer: To hide customizer set displayCustomizer value false in config.js.  -->
    <script src="${cPath}/resources/assets/vendor/js/template-customizer.js"></script>
...
Please contact your site administrator.
        ...
        <a href="${cPath}/index.do" class="btn btn-primary">Back to home</a>
        <div class="mt-5">
          <img
            src="${cPath}/resources/assets/img/illustrations/girl-with-laptop-light.png"
    ...
    <script src="${cPath}/resources/assets/vendor/libs/i18n/i18n.js"></script>
    <script src="${cPath}/resources/assets/vendor/libs/typeahead-js/typeahead.js"></script>
